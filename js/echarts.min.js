! function(t, e) {
	...
	function em(t) {
		var e = [],
			...
			a = t.get("padding");
		return i && e.push(Qg(i)), n && (_x.canvasSupported ? e.push("background-Color:" + n) : (e.push("background-Color:#" + Pt(n)), e.push("filter:alpha(opacity=0)"))), KL(["width", "color", "radius"], function(i) {
			var n = "border-" + i,
				o = JL(n),
				a = t.get(o);
